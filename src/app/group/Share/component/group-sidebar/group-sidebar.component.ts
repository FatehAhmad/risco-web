...
export class GroupSidebarComponent implements OnInit {
  ...
  constructor(private objDataService:DataService,private objRouter:Router,private objUserService:UserService, private objGroupService:GroupService, private objRoute:ActivatedRoute) {
