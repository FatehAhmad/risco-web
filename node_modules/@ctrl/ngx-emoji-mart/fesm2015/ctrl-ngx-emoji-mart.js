...
import { ChangeDetectionStrategy, Component, EventEmitter, Input, Output, Injectable, ChangeDetectorRef, ViewChild, ViewChildren, NgModule, defineInjectable, inject } from '@angular/core';
...
/** @nocollapse */ EmojiFrequentlyService.ngInjectableDef = defineInjectable({ factory: function EmojiFrequentlyService_Factory() { return new EmojiFrequentlyService(); }, token: EmojiFrequentlyService, providedIn: "root" });
...
/** @nocollapse */ EmojiSearch.ngInjectableDef = defineInjectable({ factory: function EmojiSearch_Factory() { return new EmojiSearch(inject(EmojiService)); }, token: EmojiSearch, providedIn: "root" });
